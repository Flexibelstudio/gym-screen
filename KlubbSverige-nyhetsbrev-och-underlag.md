# SmartStudio × KlubbSverige — nyhetsbrev & underlag
...
Jag driver själv studios och kände igen mig alldeles för väl. Tänk om passet redan var uppe på skärmen när medlemmarna kom – så att coachen kunde vända sig om, säga hej och bygga den där gemenskapen i stället?

Det var därför vi byggde SmartStudio. Coachen tar helt enkelt en bild på passet – handskrivet, whiteboard, vad som helst – och på några sekunder gör systemet om det till ett snyggt, digitalt pass på storskärmen, med inbyggda timers och läsbart tvärs över hela salen.
...
## Underlag att skicka in till KlubbSverige
...
- Vem hos er som är **kontaktperson** för inkommande leads
- **Deadline** från KlubbSverige för när avtal + underlag måste vara inne (fråga ställd till Sofie)

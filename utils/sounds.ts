class SoundEngine {
    ...
    cardFlip() {
        try {
            ...
            // Noise burst for the "slide" of the card
            ...
            // Filter to make it sound like paper (bandpass or lowpass)
            const filter = ctx.createBiquadFilter();
            ...
            // Add a tiny "snap" tone
            this.playTone(400, 'triangle', 0.03, 0.2, true);
        } catch (e) {
            console.error("Audio error", e);
        }
    }

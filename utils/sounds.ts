class SoundEngine {
    ...
    cardFlip() {
        // Ett rent, mjukt "plopp" (sine wave) som låter som ett trevligt UI-klick
        // Mycket bättre för upprepade klick än brus (noise)
        this.playTone(800, 'sine', 0.05, 0.15, true);
    }

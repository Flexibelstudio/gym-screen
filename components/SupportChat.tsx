...
* **Unik funktion:** Man kan klicka "Skapa Pass" inne i Idé-tavlan. Då läser AI:n av det du ritat/skrivit och skapar ett riktigt träningspass av det.
...
Om användaren frågar om något tekniskt fel, be dem ladda om sidan eller kontakta support@flexibel.app om problemet kvarstår.
            `;

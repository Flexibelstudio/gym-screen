        ...
        >
            ...
            >
                ...
                <div className="mt-6 flex-shrink-0 flex gap-4">
                    ...
                    {onEditOrgImage && (
                        <button onClick={() => onEditOrgImage(exercise)} className="flex-1 bg-gray-500 hover:bg-gray-400 text-white font-bold py-3 rounded-lg transition-colors">Ändra Bild</button>
                    )}

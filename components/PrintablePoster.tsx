...
export const PrintablePoster: React.FC<PrintablePosterProps> = ({ title, code, url, organizationName }) => {
  return (
    <div className="print-only w-full bg-white text-black flex flex-col items-center justify-center" style={{ height: '100vh', maxHeight: '100vh', overflow: 'hidden', boxSizing: 'border-box', pageBreakInside: 'avoid' }}>
      <div className="max-w-3xl mx-auto flex flex-col items-center w-full px-12 py-12">
        <h2 className="text-xl font-bold text-gray-500 mb-2 uppercase tracking-widest">{organizationName}</h2>
        <h1 className="text-4xl sm:text-5xl font-black mb-10 leading-tight uppercase max-w-2xl text-center">{title}</h1>
        
        <div className="bg-gray-50 p-8 rounded-[3rem] border-4 border-gray-100 flex flex-col items-center mb-12 shadow-xl w-full max-w-md">
        ...
        <div className="text-left w-full max-w-2xl space-y-6">
          <h3 className="text-2xl font-black uppercase tracking-widest border-b-2 border-gray-200 pb-3 mb-5">Så här gör du:</h3>

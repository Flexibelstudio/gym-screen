      ...
      <div className="max-w-3xl mx-auto flex flex-col items-center w-full pt-6 pb-4">
        ...
        <div className="text-left w-full max-w-xl space-y-5 mx-auto">
          ...
          <div className="flex items-start gap-5">
            ...
            <p className="text-xl font-semibold leading-relaxed text-black">Scanna QR-koden ovan med din mobilkamera, eller gå in på <span className="font-black">smartstudio.se</span> och ange koden <span className="font-black bg-gray-100 px-3 py-1 rounded-lg">{code}</span>.</p>
          </div>
          <div className="flex items-start gap-5">

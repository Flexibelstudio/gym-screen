...
import { Workout, WorkoutCategory, CustomCategoryWithPrompt, StudioConfig } from '../types';
    ...
    <div className="bg-white dark:bg-gray-900/50 p-4 rounded-lg flex flex-col sm:flex-row justify-between sm:items-center gap-4 border border-gray-200 dark:border-gray-700 hover:bg-gray-200/50 dark:hover:bg-gray-900/80 transition-colors">
        <div className="text-left flex-grow">
            ...
            <div className="flex items-center gap-4 text-sm text-gray-500 dark:text-gray-400 mt-1">
              ...
              <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${workout.isPublished ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200' : 'bg-gray-200 text-gray-800 dark:bg-gray-700 dark:text-gray-300'}`}>
        ...
        <div className="animate-fade-in">
          ...
          {mode === 'manage' && (
             <div className="space-y-8">
                <div>
                    <h2 className="text-2xl font-bold text-left mb-2 text-white">Mina Sparade Pass & Utkast</h2>
                    <p className="text-gray-400 text-left mb-4 text-sm">
                        Dina personliga pass eller utkast. Dessa är inte synliga för andra medlemmar på hemskärmen.
                    </p>
                    {unpublishedWorkouts.length > 0 ? (
                ...
                <div>
                    ...
                    <p className="text-gray-400 text-left mb-4 text-sm">
                        Dessa pass är synliga för medlemmar på hemskärmen under sin kategori.
                    </p>

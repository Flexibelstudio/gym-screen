                ...
                >
                    <defs>
                        ...
                        <clipPath id="glass-inner-large">
                            <path d="M 17,14 L 17,118 A 18,18 0 1,0 23,118 L 23,14 A 3,3 0 0,0 17,14 Z" />
                        </clipPath>
                    </defs>

                    {/* Glowing backlight to make the mercury look bright & active */}
                    <path 
                        d="M 17,14 L 17,118 A 18,18 0 1,0 23,118 L 23,14 A 3,3 0 0,0 17,14 Z"
                        fill={color}
                        opacity="0.25"
                    ...
                    <path 
                        d="M 16,12 L 16,117 A 19.5,19.5 0 1,0 24,117 L 24,12 A 4,4 0 0,0 16,12 Z" 

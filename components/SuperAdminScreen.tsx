...
import { StudioConfig, Studio, Organization, CustomPage, CustomCategoryWithPrompt, Page, UserData, UserRole, EquipmentItem, InfoCarousel, InfoMessage } from '../types';
...
type AdminTab = 'drift' | 'info' | 'utrustning' | 'organisation' | 'admin';
...
const ImageUploaderForBanner: React.FC<{
  ...
  const handleFile = async (file: File | null) => {
    ...
    try {
        const resizedImage = await resizeImage(file, 512, 512, 0.7);

...
const SavedWorkoutsScreen: React.FC<SavedWorkoutsScreenProps> = ({ workouts, onSelectWorkout, onEditWorkout, onDeleteWorkout, onToggleFavorite }) => {
        ...
        <div className="w-full max-w-5xl mx-auto animate-fade-in pb-8">
            <div className="text-center p-4 mb-6 bg-yellow-100 dark:bg-yellow-900/30 rounded-lg border border-yellow-200 dark:border-yellow-800/50">
                <p className="text-yellow-800 dark:text-yellow-200 text-sm">
                    Pass markerade som favoriter (⭐) sparas permanent. Övriga utkast, som 'Dagens Boost', rensas automatiskt efter 24 timmar.
                </p>
            </div>
            {workouts.length > 0 ? (
                ...
                <div className="text-center p-12 bg-gray-100 dark:bg-gray-800 rounded-lg border border-dashed border-gray-200 dark:border-gray-700">
                    <p className="text-gray-500 dark:text-gray-400 text-lg">Du har inga sparade pass ännu.</p>

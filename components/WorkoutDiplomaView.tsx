...
export const WorkoutDiplomaView: React.FC<WorkoutDiplomaViewProps> = ({ diploma, onClose }) => {
    ...
    // imagePrompt contains the Emoji/Icon in the new system
                ...
                <div className="relative z-10 flex flex-col h-full justify-between p-8 sm:p-10 text-center">
                    ...
                    <div className="flex-grow flex flex-col items-center justify-center py-6">
                        <motion.div 
                            ...
                            className="text-[8rem] sm:text-[10rem] leading-none filter drop-shadow-2xl mb-6 transform hover:scale-110 transition-transform cursor-default"
                        >
                            {icon}
                        </motion.div>
                    ...
                    <div className="pb-4">
                        <div className="flex justify-between items-end px-2 opacity-60">
                            ...
                            <div className="text-right">
                                ...
                                <p className="text-xs font-bold text-primary uppercase">{studioName}</p>
                            </div>
                        </div>
                    </div>
                </div>

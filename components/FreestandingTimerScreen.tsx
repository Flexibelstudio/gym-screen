    ...
    const handleStartTimer = () => {
        ...
        switch (mode) {
            ...
            case TimerMode.EMOM:
                ...
                break;
            case TimerMode.Stopwatch:
                actualMode = TimerMode.AMRAP; // Use AMRAP logic to count up
                settings = { ...settings, mode: actualMode, workTime: 3600, restTime: 0, rounds: 1 }; 
                title = `Stoppur`;
        ...
        const blockToStart: WorkoutBlock = { 
            ...
            settings: {...settings, mode: actualMode} as TimerSettings, 
            exercises,
            followMe: true, // Freestanding is always "follow me" style
        };
                        ...
                        <div className="flex flex-col items-center w-full">
                            ...
                            <div className="flex items-end justify-center gap-2 sm:gap-4">
                                ...
                                <ValueAdjuster
                                    ...
                                    wrapAround={true}
                                    onWrap={(dir) => {
                                        if (dir === 'up') setWorkMinutes(m => m + 1);
                                        else if (dir === 'down' && workMinutes > 0) setWorkMinutes(m => m - 1);
                                    }}
                                />
                            </div>
                        </div>
                        <div className="flex flex-col items-center w-full">
                            ...
                            <div className="flex items-end justify-center gap-2 sm:gap-4">
                                ...
                                <ValueAdjuster
                                    ...
                                    wrapAround={true}
                                    onWrap={(dir) => {
                                        if (dir === 'up') setRestMinutes(m => m + 1);
                                        else if (dir === 'down' && restMinutes > 0) setRestMinutes(m => m - 1);
                                    }}
                                />
                            </div>
                        </div>

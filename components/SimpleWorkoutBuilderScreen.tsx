...
const ExerciseItem: React.FC<ExerciseItemProps> = ({ exercise, onUpdate, onRemove, onOpenHandwriting, exerciseBank, organizationId }) => {
    ...
    return (
        <div ref={searchContainerRef} className="relative">
            ...
            {isSearchVisible && searchResults.length > 0 && (
                <ul className="absolute top-full left-0 right-0 mt-1 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg z-10 max-h-60 overflow-y-auto">
    ...
    return (
        <div className="bg-gray-100 dark:bg-slate-800 rounded-lg p-6 shadow-lg border border-gray-200 dark:border-slate-700 space-y-4">
            <div className="flex justify-between items-center">
                ...
                {index > 1 && (
                    <button onClick={() => onRemove(block.id)} className="text-red-600 hover:text-red-50 flex-shrink-0 ml-4 font-semibold">
                        Ta bort
                    </button>
                )}
            </div>

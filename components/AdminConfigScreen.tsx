...
type BooleanStudioConfigKeys = 'enableBoost' | 'enableWarmup' | 'enableBreathingGuide' | 'checkInImageEnabled' | 'enableNotes' | 'enableScreensaver' | 'enableExerciseBank' | 'enableHyrox';

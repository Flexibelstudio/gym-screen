...
type BooleanStudioConfigKeys = 'enableBoost' | 'enableWarmup' | 'enableBreathingGuide' | 'enableBoostQrLogging';
    ...
    return (
        <div className="w-full max-w-2xl mx-auto space-y-8 animate-fade-in pb-24">
            ...
            <div className="bg-gray-800 p-6 rounded-lg space-y-2 border border-gray-700">
                ...
                {effectiveConfig.enableBoost && (
                    <div className="pl-8 border-l-2 border-gray-700 ml-3 py-2">
                         {renderToggle('enableBoostQrLogging', "QR-kod för 'Dagens Boost'")}
                    </div>
                )}

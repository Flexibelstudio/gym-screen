    ...
    const settingsText = useMemo(() => {
        ...
        switch(mode) {
            ...
            case TimerMode.Tabata:
                 // New logic: 'rounds' from settings now means total intervals for this mode.
                return `Intervall: ${rounds}x (${formatTime(workTime)} arbete / ${formatTime(restTime)} vila) ${prepText}`;

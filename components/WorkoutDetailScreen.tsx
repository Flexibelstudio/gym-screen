...
import { Workout, WorkoutBlock, TimerMode, TimerSettings, Exercise, Passkategori, StudioConfig, WorkoutResult } from '../types';
import { TimerSetupModal } from './TimerSetupModal';
import { StarIcon } from './icons';
import { getWorkoutResults, uploadImage } from '../services/firebaseService';
...
}> = ({ imageUrl, onImageChange, organizationId }) => {
...
const WorkoutDetailScreen: React.FC<WorkoutDetailScreenProps> = ({ workout, onStartBlock, onUpdateBlockSettings, onEditWorkout, isCoachView, onTogglePublish, onToggleFavorite, onDuplicate, onShowImage, isPresentationMode, studioConfig, onDelete }) => {
...
const WorkoutBlockCard: React.FC<WorkoutBlockCardProps> = ({ block, onStart, onEditSettings, onUpdateBlock, isCoachView, onShowImage, organizationId }) => {
    ...
    const handleAddExercise = () => {
        ...
        onUpdateBlock({ ...block, exercises: newExercises, settings: newSettings });
    };
    ...
    const handleRemoveExercise = (exId: string) => {
        ...
        onUpdateBlock({ ...block, exercises: updatedExercises, settings: newSettings });
    };

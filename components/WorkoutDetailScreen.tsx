...
interface WorkoutDetailScreenProps {
  ...
  onShowImage: (url: string) => void; // Not used for exercise anymore, kept for potential future use or other image types
...
const WorkoutDetailScreen: React.FC<WorkoutDetailScreenProps> = ({ 
  ...
  // Only show sidebar (Quick Nav "Innehåll", AI tools, Actions) if user is a coach/admin
...
// New Component: Consolidated AI Panel
...
// WorkoutBlockCard Component (Cleaned Up)

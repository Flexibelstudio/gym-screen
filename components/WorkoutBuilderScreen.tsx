...
export const WorkoutBuilderScreen: React.FC<WorkoutBuilderScreenProps> = ({ initialWorkout, onSave, onCancel, focusedBlockId: initialFocusedBlockId, studioConfig, sessionRole }) => {
                ...
                {sessionRole !== 'member' && (
                  <div className="pt-4 border-t border-gray-700 space-y-4">
                      ...
                      <p className="text-xs text-gray-500 mt-1 pl-2">
                          Om passet publiceras blir det synligt för medlemmar under vald passkategori på hemskärmen.
                      </p>
                  </div>
                )}
            </div>
...
const EditableBlockCard: React.FC<EditableBlockCardProps> = ({ block, onUpdate, onRemove, onEditSettings, isDraggable, workoutTitle, workoutBlocksCount, editorRefs }) => {
    ...
    const handleAddExercise = () => {
      ...
      onUpdate({ ...block, exercises: [...block.exercises, newEx] });

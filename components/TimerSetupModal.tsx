...
export const TimerSetupModal: React.FC<TimerSetupModalProps> = ({ isOpen, onClose, block, onSave }) => {
  ...
  const handleSave = () => {
    // We create a partial settings object, but we make sure to explicitly
    // set all relevant properties for the selected mode to avoid stale values
    // from previous modes leaking through the parent component's merge logic.

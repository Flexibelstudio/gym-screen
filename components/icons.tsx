...
export const QrCodeIcon: React.FC<{className?: string}> = ({className = "h-8 w-8"}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 15.75h4.5a1.125 1.125 0 001.125-1.125v-4.5a1.125 1.125 0 00-1.125-1.125h-4.5M15 12h.008v.008H15V12zm0 0h.008v.008H15V12zm0 0h.008v.008H15V12zm0 0h.008v.008H15V12zm6-6h.008v.008H21V6zm0 0h.008v.008H21V6zm0 0h.008v.008H21V6zm0 0h.008v.008H21V6zm-6 6h.008v.008H15V12zm-6 0h.008v.008H9V12zm6 0h.008v.008H15V12zm0 0h.008v.008H15V12zm-6-6h.008v.008H9V6zm0 0h.008v.008H9V6z" />
    </svg>
);

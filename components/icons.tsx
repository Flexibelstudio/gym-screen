...
export const ValueAdjuster: React.FC<{
    ...
    const handleDecrement = () => {
        ...
        if (newVal < 0) {
            if (wrapAround && max !== undefined) newVal = max;
            else newVal = 0;
        }
        onchange(newVal);
    };
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <div className="flex items-center gap-2 bg-white dark:bg-black p-1 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                <button 
...
export const StarIcon: React.FC<{ className?: string, filled?: boolean }> = ({ className = "w-6 h-6", filled }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill={filled ? "currentColor" : "none"} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.049 2.927c.3-.921 1.603-.921 1.603 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
    </svg>
);
...
export const TrophyIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 013 3h-15a3 3 0 013-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0V5.625a2.25 2.25 0 10-4.5 0v5.875M12 5.625v-1.5a2.25 2.25 0 114.5 0v1.5M12 5.625v-1.5a2.25 2.25 0 10-4.5 0v1.5m0 0h4.5" />
    </svg>
);

export const QrCodeIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v1m6 11h2m-6 0h-2v4h2v-4zm-6 0H6v4h2v-4zm-6 0H2v4h2v-4zm-6 0H2v4h2v-4zm-6 0H2v4h2v-4zm-6 0H2v4h2v-4zm-6 0H2v4h2v-4z" style={{display:'none'}} />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v1m6 11h2m-6 0h-2v4h2v-4zm-6 0H6v4h2v-4zm-6 0H2v4h2v-4zm-6 0H2v4h2v-4zm-6 0H2v4h2v-4zm-6 0H2v4h2v-4zm-6 0H2v4h2v-4z" />
...
export const UnlinkIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M13.19 8.688a4.5 4.5 0 0 1 1.242 7.244l-4.5 4.5a4.5 4.5 0 0 1-6.364-6.364l1.757-1.757m13.35-.622 1.757-1.757a4.5 4.5 0 0 0-6.364-6.364l-4.5 4.5a4.5 4.5 0 0 0 1.242 7.244M10.5 10.5 13.5 13.5" />
    </svg>
);
...
export const ICON_OPTIONS = [
    ...
    { key: 'users', label: 'Grupp', component: UsersIcon },
    { key: 'document', label: 'Dokument', component: DocumentTextIcon },
    { key: 'pencil', label: 'Penna', component: PencilIcon },
    { key: 'chart', label: 'Diagram', component: ChartBarIcon },
];

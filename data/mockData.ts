...
export const MOCK_RACES: HyroxRace[] = [
    {
        ...
        startGroups: [{ id: 'g1', name: 'Startgrupp A', participants: ['Alice', 'Bob'] }],
        results: [
    ...
    },
    {
        ...
        startGroups: [{ id: 'g1', name: 'Tävlande', participants: ['Charlie', 'Dana'] }],
        results: [
...
export const MOCK_ORGANIZATIONS: Organization[] = [
    {
        ...
        exerciseOverrides: {
          'bank_bw_1': {
            imageUrl: 'data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIxMDAiIGhlaWdodD0iMTAwIj48cmVjdCB3aWR0aD0iMTAwIiBoZWlnaHQ9IjEwMCIgZmlsbD0icmVkIiAvPjwvc3ZnPg=='
          },
          'bank_kb_1': {
            imageUrl: 'data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIxMDAiIGhlaWdodD0iMTAwIj48cmVjdCB3aWR0aD0iMTAwIiBoZWlnaHQ9IjEwMCIgZmlsbD0iYmx1ZSIgLz48L3N2Zz4='
          }
        },
        companyDetails: {},
        discountType: 'fixed',

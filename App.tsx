...
const MainContent: React.FC = () => {
  ...
  const inactivityTimerRef = useRef<number | null>(null);
    ...
    const pagesThatPreventScreensaver: Page[] = [
        Page.Timer,
        Page.RepsOnly,
        Page.IdeaBoard, // IdeaBoard prevents screensaver
    ];
  ...
  const handleSwitchToStudioView = (studio: Studio) => {
    // VIKTIGT: För att studioläget ska veta vilken organisation den tillhör
    // vid en omladdning eller när kontexten återinitieras, måste vi se till
    // att LOCAL_STORAGE_ORG_KEY är satt korrekt.
    if (selectedOrganization) {
